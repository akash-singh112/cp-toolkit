  ...
  return (
    <>
      ...
      <ul>
        ...
        <li><Link to='/graph-visual' className='atags'>Graph Visualiser and Shortest Path Calculator</Link></li>
        <li><Link to='/mst' className='atags'>Minimum Spanning Tree(MST) generator</Link></li>
        <li><Link to='/run-calc' className='atags'>Runtime Calculator</Link></li>
        <li><Link to='#' className='atags'>Rank Predictor for Codeforces Contests</Link></li>
        <li><Link to='/code-snippets' className='atags'>Code Snippets</Link></li>
      </ul>
      <Footer/>
    </>
  )
